function Recommends() {
    return(
        <div className='p-6' id='recommends'>
                <p className='text-3xl font-semibold text-primary dark:text-white'>Recommends</p>
                <div id="scroll-container" className='w-auto h-72 items-center mt-6 overflow-x-auto overscroll-x-contain flex space-x-6 overflow-hidden'>
                    <div className='card'>
                        ...
                        <div className='w-full h-2/5 bg-secundary rounded-b-lg py-3 dark:bg-gray-700'>
                    ...
                    <div className='card'>
                        ...
                        <div className='w-full h-2/5 bg-white rounded-b-lg py-3 dark:bg-gray-800'>
                            <p className='text-terciary text-bold text-xl px-2 dark:text-white'>New York</p>
                            <p className='text-terciary text-lg px-2 dark:text-white'>Manhattan</p>
                        </div>
                    </div>
                    <div className='card'>
                    ...
                    <div className='card'>
                        ...
                        <div className='w-full h-2/5 bg-white rounded-b-lg py-3 dark:bg-gray-800'>
                            <p className='text-terciary text-bold text-xl px-2 dark:text-white'>Seattle</p>
                            <p className='text-terciary text-lg px-2 dark:text-white'>Big City</p>
                        </div>
                    </div>
                    <div className='card'>
                    ...
                    <div className='card'>
                        ...
                        <div className='w-full h-2/5 bg-white rounded-b-lg py-3 dark:bg-gray-800'>
                            <p className='text-terciary text-bold text-xl px-2 dark:text-white'>Sydney</p>
                            <p className='text-terciary text-lg px-2 dark:text-white'>Visit a great place</p>
                        </div>
                    </div>    
                    <div className='card'>
